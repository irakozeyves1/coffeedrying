...
<div style="width:800px; height:330px; background:#99CCFF; margin:0px auto 0px auto"><h1 align="center"; style="color:#663333; size:2">Selling Search</h1>
<?php include('conection.php'); ?>

<body>
     
	    <center> <form method="post" action="sellingupdate.php">
...
<div style=" max-height:200px; max-width:400px; overflow:scroll">
              ...
              <center>  <table cellpadding="2" cellspacing="2" border="2" bordercolor="#000000" class="table table-striped table-bordered" >
                    ...
                    <thead >
                         <tr> <th>Id</th><th>Date</th><th>Quantity</th><th>Price</th><th>Customer</th><th>Update</th></tr>
                    </thead>
                    <tbody>
                        <?php
                        $search=$_REQUEST['search'];
$query="select * from selling where sel_id like '%$search%' or date like '%$search%' or qty like '%$search%' or price like '%$search%' or custo_name like '%$search%'";
