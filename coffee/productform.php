...
<div style="width:800px; height:280px; background:#99CCFF; margin:0px auto 0px auto"><h1 align="center"; style="color:#663333; size:2">Product register</h1><form method="post" action="productsend.php">
<table align="center">
<tr><td>Product:</td><td><select name="name1">
    <option value="select">select</option>
    <option value="coffe">Coffe</option>
  </select></td></tr>
<tr><td>Quantity:</td><td><input type="text" name="name2"></td></tr>
<tr><td>Supplier Name:</td><td><input type="text" name="name3"></td></tr>



<tr><td><center><button type="submit" name="Submit" value="submit">SAVE</button></center></td></tr>

<?php include('conection.php'); ?>

<body>
             
              <center><table cellpadding="2" cellspacing="2" border="2" bordercolor="#000000" class="table table-striped table-bordered"; align="center" >
<center>PURCHASE UNITY PRICE</center>
