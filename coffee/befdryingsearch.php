...
<div style="width:800px; height:330px; background:#99CCFF; margin:0px auto 0px auto"><h1 align="center"; style="color:#663333; size:2">Coffee Before Drying Search</h1>
<?php include('conection.php'); ?>

<body>
     
	    <center> <form method="post" action="befdryingupdate.php">
...
<div style=" max-height:200px; max-width:500px; overflow:scroll">
              ...
              <center>  <table cellpadding="2" cellspacing="2" border="2" bordercolor="#000000" class="table table-striped table-bordered" >
                    ...
                    <thead >
                         <tr> <th>Id</th><th>Date</th><th>Quantity</th><th>Update</th></tr>
                    </thead>
                    <tbody>
                        <?php
                        $search=$_REQUEST['search'];
$query="select * from bdrying where id_bdry like '%$search%' or date like '%$search%' or qty like '%$search%'";
