...
<div style="width:800px; height:280px; background:#99CCFF; margin:0px auto 0px auto"><h1 align="center"; style="color:#663333; size:2">Coffee register After drying</h1><form action="Afdryingsend.php" method="post">
<center>
