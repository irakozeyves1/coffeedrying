...
<div style="width:800px; height:330px; background:#99CCFF; margin:0px auto 0px auto"><h1 align="center"; style="color:#663333; size:2">Selling Report</h1>
<?php include('conection.php'); ?>

<body>
               <center> <form method="post" action="sellingsearch.php">
...
<div style=" max-height:200px; max-width:500px; overflow:scroll">
              ...
              <center>  <table cellpadding="2" cellspacing="2" border="2" bordercolor="#000000" class="table table-striped table-bordered" >
                    ...
                    <thead >
                          <tr> <th>id</th><th>date</th><th>product</th><th>Quantity</th><th>Tptal pice</th><th>Customer</th><th>UPDATE</th></tr>
                    </thead>
                    <tbody>
                        <?php
                        $query =mysql_query("select s.sel_id,s.date,p.pro_name,s.qty,s.price,s.custo_name from selling as s,product as p where s.p_id=p.p_id")or die(mysql_error());
				...
				echo '<td>' . $row['custo_name'] . '</td>';
				
				
	 echo"<td ><a href ='sellingup.php?sel_id=$id'>";?><button type="button" name="Submit" onClick="return confirm('You Are Going to Update Record!!')">update</button><?php print"</a></td>";
