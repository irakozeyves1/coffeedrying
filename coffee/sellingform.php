...
<div style="width:800px; height:280px; background:#99CCFF; margin:0px auto 0px auto"><h1 align="center"; style="color:#663333; size:2">Selling register</h1><form action="sellingsend.php" method="post">
<center>
...
<tr><td>Customer Name:</td><td><input type="text" name="name3"></td></tr>
...
<body>
              ...
              <center><table cellpadding="2" cellspacing="2" border="2" bordercolor="#000000" class="table table-striped table-bordered" >
                    ...
                    <tbody>
                        <?php
                        $query =mysql_query("select * from sell_price")or die(mysql_error());
	 ...
	 echo"<td ><a href ='sellingpriceup.php?sel_id=$id'>";?><button type="button" name="Submit" onClick="return confirm('You Are Going to Update Record!!')">update</button><?php print"</a></td>";
