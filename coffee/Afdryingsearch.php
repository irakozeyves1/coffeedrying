...
<div style="width:800px; height:330px; background:#99CCFF; margin:0px auto 0px auto"><h1 align="center"; style="color:#663333; size:2">Coffee After Drying Search</h1>
<?php include('conection.php'); ?>

<body>
     
	    <center> <form method="post" action="Afdryingupdate.php">
...
$query="select * from adrying where adry_id like '%$search%' or date like '%$search%' or qty like '%$search%'";
